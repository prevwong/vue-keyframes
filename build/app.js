...
exports.f = __webpack_require__(6) ? _defineProperty2.default : function defineProperty(O, P, Attributes) {
  anObject(O);
...
var _preventExtensions = __webpack_require__(96);

var _preventExtensions2 = _interopRequireDefault(_preventExtensions);

var _isExtensible = __webpack_require__(57);
...
var _getOwnPropertyNames = __webpack_require__(44);
...
var _getOwnPropertyDescriptor = __webpack_require__(66);
...
var _vueEsm = __webpack_require__(81);

var _vueEsm2 = _interopRequireDefault(_vueEsm);

var _vueKeyframes = __webpack_require__(156);
...
var _toStringTag = __webpack_require__(84);
...
var _setImmediate2 = __webpack_require__(130);
...
var _ownKeys = __webpack_require__(148);
...
function _createElement(context, tag, data, children, normalizationType) {
  if (isDef(data) && isDef(data.__ob__)) {
    process.env.NODE_ENV !== 'production' && warn("Avoid using observed data object as vnode data: " + (0, _stringify2.default)(data) + "\n" + 'Always create fresh vnode data objects in each render!', context);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(82), __webpack_require__(83)))
...
module.exports = __webpack_require__(24).f('toStringTag');
...
$export($export.S + $export.F * !__webpack_require__(6), 'Object', { defineProperties: __webpack_require__(61) });
...
$export($export.S + $export.F * !__webpack_require__(76)(function (iter) {
...
var _keyframes = __webpack_require__(157);
	...
	install: function install(Vue) {
		Vue.component('Keyframes', {
			...
			methods: {
				...
				animateNextFrame: function animateNextFrame() {
					...
					this.waitForDelay(function () {
						if (_this.frameNum < (0, _keys2.default)(_this.frames.data).length - 1) {
							_this.frameNum++;
			...
			render: function render(createElement) {
				...
				if (!this.register) {
					var _myChildren = this.$slots.default.filter(function (node) {
						return !node.text;
					});
					_myChildren.map(function (child, index) {
						_this2.resetFrames();
						var duration = 200;
						var freeze = false;
						...
						if (index === _myChildren.length - 1) {
							_this2.register = true;
						}
						return true;
					});
				}
				var myChildren = this.$slots.default.filter(function (node) {
					return !node.text;
